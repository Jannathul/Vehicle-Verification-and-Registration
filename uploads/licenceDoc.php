        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $Sr; ?></td>
              <td><?php echo $Id; ?></td>
              <td><img alt="NA" src="../photos/<?php echo $LPhoto; ?>" width="60px;" height="47px"</td>
              <td><span class="d-inline-block text-truncate" style="max-width: 50px;">
                <?php if (empty($LicenceNum)) {
                  echo "NA";
                }else{ echo $LicenceNum;} ?>
              </td>
              <td><span class="d-inline-block text-truncate" style="max-width: 50px;">
                <?php if (empty($LName)) {
                  echo "NA";
              ...
              <td><span class="d-inline-block text-truncate" style="max-width: 50px;">
                <?php if (empty($VehicleType)) {
                  echo "NA";
                }else{echo $VehicleType; }?></td>
              <td><span class="d-inline-block text-truncate" style="max-width: 50px;">
                <?php if (empty($LValidity)) {
                  echo "NA";
                }else{ echo $LValidity; }?></td>
              ...
              <td>
                <a href="LicenceEdit.php?ID=<?php echo $Id?>"><span class="btn btn-warning">Edit</span></a>
              </td>
              <td>
